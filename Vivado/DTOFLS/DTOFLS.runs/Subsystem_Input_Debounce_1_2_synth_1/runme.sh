...
HD_PWD='D:/PERSONAL/Projects/DTOFLS/DTOFLS.runs/Subsystem_Input_Debounce_1_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Subsystem_Input_Debounce_1_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Subsystem_Input_Debounce_1_2.tcl
