...
HD_PWD='D:/PERSONAL/Projects/DTOFLS/DTOFLS.runs/Subsystem_imageProcessTop_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Subsystem_imageProcessTop_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Subsystem_imageProcessTop_0_0.tcl
