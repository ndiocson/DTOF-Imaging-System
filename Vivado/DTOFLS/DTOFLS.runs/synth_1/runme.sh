...
HD_PWD='D:/PERSONAL/Projects/DTOFLS/DTOFLS.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Subsystem_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Subsystem_wrapper.tcl
