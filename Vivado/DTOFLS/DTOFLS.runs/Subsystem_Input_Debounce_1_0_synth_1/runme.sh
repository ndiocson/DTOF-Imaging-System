...
HD_PWD='D:/PERSONAL/Projects/DTOFLS/DTOFLS.runs/Subsystem_Input_Debounce_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Subsystem_Input_Debounce_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Subsystem_Input_Debounce_1_0.tcl
