...
HD_PWD='D:/PERSONAL/Projects/DTOFLS/DTOFLS.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Subsystem_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Subsystem_wrapper.tcl -notrace
