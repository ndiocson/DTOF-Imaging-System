...
--               d:/PERSONAL/Projects/DTOFLS/DTOFLS.gen/sources_1/bd/Subsystem/ip/Subsystem_Input_Debounce_1_4/Subsystem_Input_Debounce_1_4_sim_netlist.vhdl
-- Design      : Subsystem_Input_Debounce_1_4
...
entity Subsystem_Input_Debounce_1_4_Counter is
  port (
  ...
  attribute ORIG_REF_NAME of Subsystem_Input_Debounce_1_4_Counter : entity is "Counter";
end Subsystem_Input_Debounce_1_4_Counter;

architecture STRUCTURE of Subsystem_Input_Debounce_1_4_Counter is
  ...
  signal max_reached_i_1_n_0 : STD_LOGIC;
...
\count1_carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => \count1_carry__0_i_4_n_0\,
      S(2) => \count1_carry__0_i_5_n_0\,
      S(1) => \count1_carry__0_i_6_n_0\,
      S(0) => \count1_carry__0_i_7_n_0\
    );
...
max_reached_i_1: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
      I0 => aresetn,
      I1 => i,
      O => max_reached_i_1_n_0
    );
max_reached_reg: unisim.vcomponents.FDCE
     port map (
      C => clk,
      CE => '1',
      CLR => max_reached_i_1_n_0,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity Subsystem_Input_Debounce_1_4_Input_Debounce is
  port (
    o : out STD_LOGIC;
    aresetn : in STD_LOGIC;
    i : in STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of Subsystem_Input_Debounce_1_4_Input_Debounce : entity is "Input_Debounce";
end Subsystem_Input_Debounce_1_4_Input_Debounce;

architecture STRUCTURE of Subsystem_Input_Debounce_1_4_Input_Debounce is
  signal follow_in : STD_LOGIC;
  signal follow_in_reg_i_2_n_0 : STD_LOGIC;
  signal max_reached : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \/i_\ : label is "soft_lutpair0";
  attribute OPT_MODIFIED : string;
  attribute OPT_MODIFIED of follow_in_reg : label is "MLO";
begin
...
follow_in_reg: unisim.vcomponents.LDCP
    generic map(
      INIT => '0',
      IS_G_INVERTED => '1'
    )
        port map (
      CLR => follow_in_reg_i_2_n_0,
      D => i,
      G => i,
      PRE => max_reached,
      Q => follow_in
    );
follow_in_reg_i_2: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => aresetn,
      O => follow_in_reg_i_2_n_0
    );
wait_counter: entity work.Subsystem_Input_Debounce_1_4_Counter
     port map (
      aresetn => aresetn,
      clk => clk,
      i => i,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity Subsystem_Input_Debounce_1_4 is
  port (
    clk : in STD_LOGIC;
    aresetn : in STD_LOGIC;
    i : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of Subsystem_Input_Debounce_1_4 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of Subsystem_Input_Debounce_1_4 : entity is "Subsystem_Input_Debounce_1_4,Input_Debounce,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of Subsystem_Input_Debounce_1_4 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of Subsystem_Input_Debounce_1_4 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of Subsystem_Input_Debounce_1_4 : entity is "Input_Debounce,Vivado 2020.2";
end Subsystem_Input_Debounce_1_4;

architecture STRUCTURE of Subsystem_Input_Debounce_1_4 is
...
begin
U0: entity work.Subsystem_Input_Debounce_1_4_Input_Debounce
     port map (
      aresetn => aresetn,
      clk => clk,
      i => i,
