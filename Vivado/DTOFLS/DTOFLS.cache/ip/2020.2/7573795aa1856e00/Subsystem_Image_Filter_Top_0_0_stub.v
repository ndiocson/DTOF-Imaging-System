...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(axi_clk, axi_reset_n, ready_in, valid_in, 
  filter_sel, data_in, intr_out, ready_out, valid_out, data_out)
/* synthesis syn_black_box black_box_pad_pin="axi_clk,axi_reset_n,ready_in,valid_in,filter_sel[2:0],data_in[7:0],intr_out,ready_out,valid_out,data_out[7:0]" */;
  input axi_clk;
  input axi_reset_n;
  input ready_in;
  input valid_in;
